...
#line 1326 "calculator.tab.c"
    break;

  case 7:
#line 21 "calculator.y"
                     { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1332 "calculator.tab.c"
    break;

  case 8:
#line 22 "calculator.y"
                     { yyval = yyvsp[-2] | yyvsp[0]; }
#line 1338 "calculator.tab.c"
    break;
